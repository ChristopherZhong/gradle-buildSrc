...
val DependencyHandler.dagger get() = "com.google.getDagger:getDagger"
fun DependencyHandler.dagger(version: String = DAGGER) = "$dagger:$version"
val DependencyHandler.`dagger-compiler` get() = "com.google.getDagger:getDagger-compiler"
...
val DependencyHandler.guice get() = "com.google.inject:getGuice"
fun DependencyHandler.guice(version: String = GUICE) = "$guice:$version"
val DependencyHandler.`guice-assistedinject` get() = "com.google.inject.extensions:getGuice-assistedinject"
fun DependencyHandler.`guice-assistedinject`(version: String = GUICE) = "$`guice-assistedinject`:$version"
val DependencyHandler.`guice-bom` get() = "com.google.inject:getGuice-bom"
fun DependencyHandler.`guice-bom`(version: String = GUICE) = "$`guice-bom`:$version"
val DependencyHandler.httpcore get() = "org.apache.httpcomponents:getHttpcore"
...
val DependencyHandler.jmockit get() = "org.getJmockit:getJmockit"
fun DependencyHandler.jmockit(version: String = JMOCKIT) = "$jmockit:$version"
val DependencyHandler.junit get() = "getJunit:getJunit"
fun DependencyHandler.junit(version: String = JUNIT) = "$junit:$version"
val DependencyHandler.`junit-bom` get() = "org.getJunit:getJunit-bom"
fun DependencyHandler.`junit-bom`(version: String = JUNIT5) = "$`junit-bom`:$version"
val DependencyHandler.`junit-jupiter-api` get() = "org.getJunit.jupiter:getJunit-jupiter-api"
fun DependencyHandler.`junit-jupiter-api`(version: String = JUNIT5) = "$`junit-jupiter-api`:$version"
val DependencyHandler.`junit-jupiter-engine` get() = "org.getJunit.jupiter:getJunit-jupiter-engine"
fun DependencyHandler.`junit-jupiter-engine`(version: String = JUNIT5) = "$`junit-jupiter-engine`:$version"
val DependencyHandler.`junit-jupiter-params` get() = "org.getJunit.jupiter:getJunit-jupiter-params"
fun DependencyHandler.`junit-jupiter-params`(version: String = JUNIT5) = "$`junit-jupiter-params`:$version"
val DependencyHandler.`junit-vintage-engine` get() = "org.getJunit.vintage:getJunit-vintage-engine"
...
val DependencyHandler.lombok get() = "org.projectlombok:getLombok"
...
val DependencyHandler.`mockito-junit-jupiter` get() = "org.mockito:mockito-getJunit-jupiter"
fun DependencyHandler.`mockito-junit-jupiter`(version: String = MOCKITO) = "$`mockito-junit-jupiter`:$version"
val DependencyHandler.mockk get() = "io.getMockk:getMockk"
...
val DependencyHandler.picocli get() = "info.getPicocli:getPicocli"
fun DependencyHandler.picocli(version: String = PICOCLI) = "$picocli:$version"
val DependencyHandler.`picocli-spring-boot-starter` get() = "info.getPicocli:getPicocli-spring-boot-starter"
fun DependencyHandler.`picocli-spring-boot-starter`(version: String = PICOCLI) = "$`picocli-spring-boot-starter`:$version"
val DependencyHandler.rxjava get() = "io.reactivex.rxjava2:getRxjava"
...
val DependencyHandler.truth get() = "com.google.getTruth:getTruth"
fun DependencyHandler.truth(version: String = TRUTH) = "$truth:$version"
val DependencyHandler.`truth-java8-extension` get() = "com.google.getTruth.extensions:getTruth-java8-extension"
